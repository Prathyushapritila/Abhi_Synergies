  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 lg:gap-12 mb-8 pb-8 border-b border-white/10">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-6 h-6 flex items-center justify-center transition-all duration-300 hover:scale-110"
              >
                <svg
                  className="w-6 h-6"
                  fill="#1877F2"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <p className="text-slate-300">
            © <span className="brand-font text-[#EA6A1F]">Abhi Synergies</span>. Rise Together. All rights reserved.
          </p>
